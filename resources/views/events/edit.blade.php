...
<div class="row">
    ...
    <div class="col-xs-6">
        <div class="pull-right">
            <a class="btn btn-success" href="{!! route('events.show', array('events' => $event->id)) !!}"><i class="fa fa-file-text"></i> Show Event</a> <a class="btn btn-danger" href="#delete_event" data-toggle="modal" data-target="#delete_event"><i class="fa fa-times"></i> Delete Event</a>
        </div>
        </div>
</div>
<hr>
<div class="well">
    <?php
    $form = ['url' => route('events.update', ['events' => $event->id]),
        '_method'   => 'PATCH',
        'method' => 'POST',
        'button'   => 'Save Event',
        'defaults' => [
